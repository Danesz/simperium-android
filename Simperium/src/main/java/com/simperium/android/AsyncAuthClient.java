...
public class AsyncAuthClient implements AuthProvider {
    ...
    public void saveUser(User user) {
        SharedPreferences.Editor editor = AndroidClientHelper.getSharedPreferences(mContext).edit();
    ...
    public void restoreUser(User user) {
        SharedPreferences preferences = AndroidClientHelper.getSharedPreferences(mContext);
